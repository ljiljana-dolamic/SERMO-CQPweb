...
echo print_html_header('SERMO analyse', $Config->css_path);
echo print_sermo_header ();
?>

<div class="container">
<div class="container-wrapper column preprend-5 span-16 append-3">
...
<!-- 	</tr> -->
	...
	if ($User->logged_in)// gets info objects for all corpora matching the tegex
	{
			...
			header("Location: http://sermo.unine.ch/SERMO-CQPweb/corpus-sermo/"); /* Redirect browser */
			exit();
...
<!-- 			</td>-->
	...
	else
	{
		...
		echo "\t\t\t<p align=\"center\"><a href=\"usr/?thisQ=create&uT=y\">Créer un compte</a>";
