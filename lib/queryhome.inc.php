...
<div class="container">
	<div class="side-menu column span-5">
		<div  id="filters"  class="span-24">
			<ul class="filters">
	<?php   

        echo print_menurow_index_list('subcorpus', 'Créer un sous-corpus');
        echo print_menurow_index_list('search', 'Concordances');
		echo print_menurow_index_list('freqList', 'Lexique');
		echo print_menurow_index_list('history', 'Mes requêtes');
		
		//echo print_menurow_index('search', 'Requête standarde');
		//echo print_menurow_index('lookup', 'Chercher un mot');
...
{
	?>
<table class="concordtable prepend-2 span-20">
	<tr>
...
case 'clocurve': // TODO, note this is an unfinished UI issue... clocurve should prob be wihtin Analyse Corpus but currently rhere's just a link. 
	printquery_clocurve();
	$helplink = 'hello';
	break;
