...
// {
	...
	echo print_menurow_index_list('login', "S'identifier");
	echo print_menurow_index_list('create', 'Créer un compte');
	echo print_menurow_index_list('verify', 'Activer un nouveau compte');
	echo print_menurow_index_list('resend', "Renvoyer l'activation du compte");
	echo print_menurow_index_list('lostUsername', "Nom d'utilisateur perdu");
	echo print_menurow_index_list('lostPassword', 'Mot de passe perdu');
//}
