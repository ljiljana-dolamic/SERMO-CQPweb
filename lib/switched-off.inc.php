...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="<?php echo ($Config->run_location == RUN_LOCATION_MAINHOME ? 'css' : '../css'); ?>/CQPweb.css" >
	</head>
	<body>
	
		<table class="concordtable" width="100%">
			<tr>
				<th class="concordtable">The CQPweb server is currently switched off - back soon!</th> 
			</tr>
			<tr>
		...
		<table class="concordtable" width="100%">
			<tr>
				<td align="left" class="cqpweb_copynote" width="33%">
					CQPweb v<?php echo CQPWEB_VERSION; ?> &#169; 2008-2016
				</td>
