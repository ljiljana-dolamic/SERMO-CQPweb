...
echo print_html_header("{$Corpus->title} -- Options de collocation", $Config->css_path, array('cword', 'colloc-options'));
...
<table width="100%" class="concordtable" id="tableCollocProximity">
	<form action="collocation.php" method="get">
		...
		<tr>
			<td class="concordgrey">Empan:</td>
			<td class="concordgeneral" align="center" colspan="2">
<!-- 				+ / - -->
				
				<input type="text" name="maxCollocSpan" value="1" size="8" />
...
// 					?>
		...
		*/
		...
		<tr>
			<th colspan="3" class="concordtable">
				<input type="submit" value="Créer la base de collocations"/>
			</th>
		</tr>
		<?php 
